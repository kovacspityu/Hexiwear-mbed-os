...
{
    STATUS                      = 0x00,
    PRESSURE_CSB                = 0x01,             ALTITUDE_CSB                = 0x01,
    PRESSURE_LSB                = 0x02,             ALTITUDE_LSB                = 0x02,
    PRESSURE_MSB                = 0x03,             ALTITUDE_MSB                = 0x03,
    TEMPERATURE_MSB             = 0x04,
    TEMPERATURE_LSB             = 0x05,
    DR_STATUS                   = 0x06,
    PRESSURE_DELTA_CSB          = 0x07,             ALTITUDE_DELTA_CSB          = 0x07,
    PRESSURE_DELTA_LSB          = 0x08,             ALTITUDE_DELTA_LSB          = 0x08,
    PRESSURE_DELTA_MSB          = 0x09,             ALTITUDE_DELTA_MSB          = 0x09,
    ...
    MIN_PRESSURE_MSB            = 0X1E,             MIN_ALTITUDE_MSB            = 0X1E,
    ...
    MAX_PRESSURE_MSB            = 0X23,             MAX_ALTITUDE_MSB            = 0X23,
