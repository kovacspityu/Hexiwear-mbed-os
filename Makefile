...
OBJECTS += ./sources/sensors/FXAS21002C.o
OBJECTS += ./sources/sensors/HTU21D.o
OBJECTS += ./sources/sensors/MAX30101.o
OBJECTS += ./sources/sensors/MPL3115A2.o
OBJECTS += ./sources/sensors/TSL2561.o
OBJECTS += ./sources/sensors/FXOS8700CQ.o
...
OBJECTS += ./mbed-os/features/unsupported/dsp/cmsis_dsp/StatisticsFunctions/arm_mean_f32.o
...
OBJECTS += ./mbed-os/features/unsupported/dsp/cmsis_dsp/CommonTables/arm_common_tables.o
OBJECTS += ./mbed-os/features/unsupported/dsp/cmsis_dsp/CommonTables/arm_const_structs.o
...
INCLUDE_PATHS += -I.././mbed-os/features/unsupported/dsp/cmsis_dsp
...
INCLUDE_PATHS += -I.././mbed-os/rtos/TARGET_CORTEX/rtx5/TARGET_CORTEX_M
INCLUDE_PATHS += -I.././mbed-os/rtos/TARGET_CORTEX/rtx5/TARGET_CORTEX_M/TARGET_RTOS_M4_M7
INCLUDE_PATHS += -I.././mbed-os/rtos/TARGET_CORTEX/rtx5/TARGET_CORTEX_M/TARGET_RTOS_M4_M7/TOOLCHAIN_GCC
